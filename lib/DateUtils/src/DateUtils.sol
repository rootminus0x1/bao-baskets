...
library DateUtils {
    ...
    function isValidDay(uint16 _year, uint8 _month, uint8 _day) private pure returns (bool) {
     ...
     */
    function isValidYMD(uint16 _y, uint8 _m, uint8 _d) internal pure returns (bool) {
     ...
     * @return Returns `true` if all inputs are valid, `false` otherwise
     */
    function isValidYMDHMS(uint16 _y, uint8 _m, uint8 _d, uint8 _h, uint8 _min, uint8 _s)
        internal
        pure
        returns (bool)
    {
     ...
     */
    function splitTimeInt(string memory _time) internal pure returns (uint8 hour, uint8 minute, uint8 second) {
    ...
    function getYear(uint256 _secondsRemaining) private pure returns (uint256 secondsRemaining, uint16 year) {
        uint256 res;
    ...
    function getDay(uint256 _secondsRemaining) private pure returns (uint256 secondsRemaining, uint8 day) {
        uint256 res;
    ...
    function YMDuintToBytes(uint16 _y, uint8 _m, uint8 _d) private pure returns (strings.slice[] memory) {
    ...
    function convertTimestampToYMDHMS(uint256 _dt)
        internal
        pure
        returns (uint16 year, uint8 month, uint8 day, uint8 hour, uint8 minute, uint8 second)
    {
        uint256 secondsRemaining = _dt;
     ...
     */
    function convertYMDtoDateString(uint16 _year, uint8 _month, uint8 _day) internal pure returns (string memory) {
     ...
     * @return Returns timestamp as `uint256`
     */
    function convertYMDtoTimestamp(uint16 _year, uint8 _month, uint8 _day) internal pure returns (uint256) {
        require(isValidYMD(_year, _month, _day));
     ...
     * @return Returns timestamp as `uint256`
     */
    function convertYMDHMStoTimestamp(uint16 _year, uint8 _month, uint8 _day, uint8 _hour, uint8 _minute, uint8 _second)
        internal
        pure
        returns (uint256)
    {
